...
public class TaskScheduleController {
	...
	@RequestMapping(value = "/createReportTask", method = RequestMethod.POST)
	@ResponseBody
	public String createReportTask(@RequestBody ReportTaskDTO dto){
		long id = reportTaskService.createReportTask(dto);
		return "The report task "+id+" was created!";
	}
