...
public class HelloWorldServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// com.wfoo.MyRepository
			String uniqueName = "com.foo.MyRepository0";
			...
			response.getWriter().println(
					"<h3>You are now connected to the Repository with Id " + openCmisSession.getRepositoryInfo().getId() + "</h3>");
			...
			ContentStream contentStream = openCmisSession.getObjectFactory().createContentStream("HelloWorld.txt", helloContent.length,
			...
			for (CmisObject o : children) {
				...
				if (o instanceof Folder) {
					...
					response.getWriter().println(
							" createdBy: " + o.getCreatedBy() + " filesize: " + doc.getContentStreamLength() + " bytes" + "</li>");
				}
			}
