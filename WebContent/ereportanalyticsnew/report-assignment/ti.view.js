sap.ui.jsview('ereportanalyticsnew.report-assignment.ti', {
	...
	createContent : function(oController) {
		...
		var tspReportAssignment = new sap.ui.commons.TabStrip({
			/**
			 * General
			 */
			height : 200 + 'px',
			 ...
			 * Event handlers
			 */
			close : function(eventArgs) {
				var tspReportAssignment0 = eventArgs.oSource;
				tspReportAssignment0.closeTab(eventArgs.getParameter("index"));
			},
		});

		return tspReportAssignment;
		// TODO: Refactor constructor as whole json style
		...
		var oLabel = new sap.ui.commons.Label({
			text : 'Template File',
			labelFor : oFileUploader
		});
		oLayout1.createRow(oLabel, oFileUploader);

		// oCell = new sap.ui.commons.layout.MatrixLayoutCell({rowSpan : 5,
		// colSpan : 2});
		...
		oTab2.setTitle(new sap.ui.commons.Title({
			text : "Template Info",
			icon : "images/address.jpg"
		}));
		...
		var oBtn3 = new sap.ui.commons.Button({
			text : "Save",
			tooltip : "",
			press : function() {
				oController.saveTemplateFile();
			},
			layoutData : new sap.ui.commons.form.GridElementData({
				hCells : "1"
			})
		});
		var oBtn4 = new sap.ui.commons.Button({
			text : "Cancel",
			tooltip : "",
			press : function() {
				oController.cancel();
