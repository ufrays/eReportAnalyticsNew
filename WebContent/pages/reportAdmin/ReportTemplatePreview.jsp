...
<%@ page import="org.sap.era.service.*,org.sap.era.persistence.*,org.sap.era.service.excel.*,java.util.Map,
...
Select Sheet:
<select onchange="javaScript:submitQuery()" name="tableModelID" id="select">
        ...
        <%
            ...
            <%
				...
				for (int j = 1; j <= colCount; j++ ){
					Control cell = controlMap.get(String.valueOf(excelForm.getStartRow() + i)+"-"+String.valueOf(excelForm.getStartCol() + j));
 ...
 <input type="button" name="button2" id="button2" onclick="javaScript:backToList()" value="Back" />
</body>
</html>